...
- **FR-007**: Sistem HARUS mengirimkan ringkasan admin secara terpisah langsung ke **pengirim** pesan komplain (private message) menggunakan format baku fungsi `buildAdminSummary()` dari `complaintResponseTemplates.js`.
