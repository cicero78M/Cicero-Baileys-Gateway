...
export const env = cleanEnv(process.env, {
  ...
  RAPIDAPI_HOST: str({ default: '' }),
  RAPIDAPI_TIMEOUT_MS: num({ default: 5000 }),
  RAPIDAPI_FALLBACK_KEY: str({ default: '' }),
  RAPIDAPI_FALLBACK_HOST: str({ default: '' }),
  RAPIDAPI_INSTAGRAM_KEY: str({ default: '' }),
  RAPIDAPI_INSTAGRAM_HOST: str({ default: 'social-api4.p.rapidapi.com' }),
  RAPIDAPI_TIKTOK_KEY: str({ default: '' }),
  RAPIDAPI_TIKTOK_HOST: str({ default: 'tiktok-api23.p.rapidapi.com' }),
  ...
  ENABLE_NEON_SYNC_CRON: bool({ default: true })
});
