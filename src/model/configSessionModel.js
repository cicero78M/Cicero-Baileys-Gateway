...
export const SessionWorkflow = {
  ...
  validTransitions: {
    ...
    [SESSION_STAGES.VIEWING_CONFIG]: [SESSION_STAGES.MODIFYING_CONFIG, SESSION_STAGES.TIMEOUT_WARNING],
    [SESSION_STAGES.MODIFYING_CONFIG]: [SESSION_STAGES.CONFIRMING_CHANGES, SESSION_STAGES.TIMEOUT_WARNING],
  ...
  getNextStage(currentStage) {
    const nextStages = {
      ...
      [SESSION_STAGES.VIEWING_CONFIG]: SESSION_STAGES.MODIFYING_CONFIG,
